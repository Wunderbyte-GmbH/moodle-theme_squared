...
function(IconSystem, $, Ajax, Mustache, LocalStorage, Url) {
    ...
    IconSystemFontawesome.prototype.init = function() {
        ...
        var map = LocalStorage.get('theme_squared/iconmap-fontawesome');
        if (map) {
            map = JSON.parse(map);
        }
        ...
        if (fetchMap === null) {
            fetchMap = Ajax.call([{
                methodname: 'theme_squared_output_load_fontawesome_icon_map',
                args: []
            }], true, false)[0];
        }
        ...
        return fetchMap.then(function(map) {
            ...
            LocalStorage.set('theme_squared/iconmap-fontawesome', JSON.stringify(staticMap));
            return this;
        }.bind(this));
    };
    ...
    IconSystemFontawesome.prototype.getTemplateName = function() {
        return 'theme_squared/pix_icon_fontawesome';
    };

    return IconSystemFontawesome; // @alias module:theme_squared/icon_system_fontawesome
