...
$plugin->version = 2015080701; // The current module version (Date: YYYYMMDDXX)
$plugin->requires  = 2015051100.00; // 2.9 (Build: 20150511).
$plugin->release = "Red Square 2.9.0.2"; // Release name: famous squares around the world followed by Moodle version followed by number
