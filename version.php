...
$plugin->release = "Heldenplatz 3.7.1.0"; // Release name: Famous squares around the world followed by Moodle version followed by stability number (> 1 = stable) followed by revision.
