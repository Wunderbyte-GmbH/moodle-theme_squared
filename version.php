...
$plugin->release = "Maria-Theresien-Platz 3.9.0.1"; // Release name: Famous squares around the world followed by Moodle version followed by stability number (> 1 = stable) followed by revision.
